...
import (
	...
	"github.com/fauli/fauli-operator/internal/controller"
...
func init() {
	...
	utilruntime.Must(fauliv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "51faa734.sbebe.ch",
	...
	if err = (&controller.FnsReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "Fns")
		os.Exit(1)
	}
